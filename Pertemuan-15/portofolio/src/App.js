        ...
        <ul style={sideBarStyle}>
          ...
          >
            <li style={{ paddingBottom: 10 }}>
              <Link to="/" style={sideBarListStyle}>
                Home
              </Link>
            </li>
          </motion.div>
          ...
          >
            <li style={{ paddingBottom: 10 }}>
              <Link to="/about" style={sideBarListStyle}>
                About
              </Link>
            </li>
          </motion.div>
          ...
          >
            <li style={{ paddingBottom: 10 }}>
              <Link to="/experience" style={sideBarListStyle}>
                Experience
              </Link>
            </li>
          </motion.div>
          ...
          >
            <li style={{ paddingBottom: 10 }}>
              <Link to="/skills" style={sideBarListStyle}>
                Skills
              </Link>
            </li>
          </motion.div>
          ...
          >
            <li style={{ paddingBottom: 10 }}>
              <Link to="/interest" style={sideBarListStyle}>
                Interest
              </Link>
            </li>
          </motion.div>
          ...
          >
            <li style={{ paddingBottom: 10 }}>
              <Link to="/Awards" style={sideBarListStyle}>
                Awards
              </Link>
            </li>
          </motion.div>
